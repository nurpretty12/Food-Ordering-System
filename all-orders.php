...
<body>
  ...
  <header id="header" class="page-topbar">
        ...
        <div class="navbar-fixed" style = "background:green">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation" style="background-image: url('images/waffle.jpg'); background-repeat: no-repeat; background-size: cover; width:16%">
            ...
            <li class="bold"><a href="index.php" class="collapsible collapsible-accordion"><i class="mdi-editor-border-color"></i> FOOD MENU</a>
            </li>
                <li class="no-padding">
            ...
            <li class="bold"><a href="users.php" class="collapsible collapsible-accordion"><i class="mdi-social-person"></i> USERS</a>
            </li>				
        </ul>
      ...
      <section id="content" >
       ...
       <div class="card-body">
        ...
        <div class="container" style="background-image: url('images/fries.jpg'); background-repeat: no-repeat; background-size: cover; width:100%">
...
while ($row = mysqli_fetch_array($sql)) {
    ...
    if ($deleted) {
        ...
        <p><strong>Status:</strong> 
            <select name="status">
                <option value="TO BE DELIVERED" ' . ($status == 'TO BE DELIVERED' ? 'selected' : '') . '>TO BE DELIVERED</option>
    ...
    while ($row3 = mysqli_fetch_array($sql3)) {
        ...
        if (!empty($row3['contact'])) {
            echo '<p><strong>Contact: </strong>' . $row3['contact'] . '</p>';
        }

        if (!empty($row3['email'])) {
            echo '<p><strong>Email: </strong>' . $row3['email'] . '</p>';
        }

        if (!empty($row['description'])) {
            echo '<p><strong>Note: </strong>' . $row['description'] . '</p>';
        }
...
if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
    ...
    $query = "SELECT * FROM orders WHERE date BETWEEN '$from_date' AND '$to_date'";
    $squery_run = mysqli_query($con, $query);
