...
<body class="cyan">
  ...
  <div id="login-page" class="row1" >
      ...
      <form class="formValidate" id="formValidate" method="post" action="routers/register-router.php" novalidate="novalidate" class="col s12" style="backdrop-filter: blur(15px)">
        <div class="row">
          <div class="input-field col s12 center">
            <h4>REGISTER</h4>
            <p class="center">M A BERKAT ENTERPRISE</p>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
            <p class="margin center medium-small sign-up">Already registered? <a href="login.php">LOGIN</a></p>
          </div>
        </div>
      </form>
    </div>
