...
{
		$feedbacks_id = $_GET['id'];
		$sql1 = "SELECT * FROM feedbacks WHERE id = $feedbacks_id;";
...
<head>
  ...
  <title>VIEW FEEDBACKS<?php echo $feedbacks_id.' - '. $type;?></title>
  ...
  <div id="main" style="background-image: url('images/chicken.jpg'); background-repeat: no-repeat; background-size: cover; width:85%">
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper" style="background-image: url('images/chicken.jpg'); background-repeat: no-repeat; background-size: cover; width:85%">
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">FEEDBACKS DETAILS</h5>
              </div>
            </div>
          </div>
        </div>
...
<div class="section" >
								...
								echo '<ul id="task-card" class="collection with-header">
									<div id="card-alert" class="card cyan">
										...
										<span class="card-title black-text darken-1">Feedbacks No. '.$feedbacks_id.'</span>
										<p><strong>Subject: </strong>'.$subject.'</p>
										<p><strong>Status: </strong>'.$status.'</p>	
										<p><strong>Type: </strong>'.$type.'</p>											
										</div>
										<div class="card-action cyan">
										<form method="post" action="routers/feedbacks-status.php">
										<input type="hidden" name="feedbacks_id" value="'.$feedbacks_id.'">										
										<input type="hidden" name="status" value="'.($status != 'CLOSED' ? 'CLOSED' : 'OPEN').'">
										<button class="waves-effect waves-light blue-grey btn white-text" type="submit" name="action">'
								...
								$sql1 = mysqli_query($con, "SELECT * from feedbacks_details WHERE feedbacks_id = $feedbacks_id;");
                  ...
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/feedbacks-message.php" novalidate="novalidate" class="col s12">					  
                      <div class="row">
