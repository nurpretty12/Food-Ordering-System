    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation" style="background-image: url('images/waffle.jpg'); background-repeat: no-repeat; background-size: cover; width:16%">
            ...
            <li class="bold active"><a href="index.php" class="collapsible collapsible-accordion"><i class="mdi-action-store"></i> FOOD MENU</a>
            </li>
                <li class="no-padding">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
            <div class="row">
			  ...
			  <div class="input-field col s12" style="backdrop-filter: blur(10px);">
              
              <textarea id="description" name="description" class="materialize-textarea"></textarea>
              <label for="description" class="" style="color:black">Pickup Time (Date and Time. Ex:17/07/23 15:00)</label>
			  </div>
			  <div>
