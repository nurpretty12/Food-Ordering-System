...
<body>
  ...
  <div id="main" style="background-image: url('images/chicken.jpg'); background-repeat: no-repeat; background-size: cover; width:85%">
    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation" style="background-image: url('images/waffle.jpg'); background-repeat: no-repeat; background-size: cover; width:16%"">
                ...
                <div class="col col s4 m4 l4">
				 ...
				 <div class="col col s8 m8 l8">
                    <ul id="profile-dropdown" class="dropdown-content">
                        <li><a href="routers/logout.php"></i> LOGOUT</a>
                        </li>
                    </ul>
                </div>
                <div class="col col s8 m8 l8">
            ...
            <li class="bold"><a href="index.php" class="collapsible collapsible-accordion"><i class="mdi-action-store"></i> FOOD MENU</a>
                    ...
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-maps-local-mall"></i> ORDERS</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="orders.php">ORDER DETAILS</a>
                                </li>
								<?php
                ...
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-communication-message"></i> FEEDBACKS</a>
                            <div class="collapsible-body">
                                <ul>
								<li class="<?php
								if(!isset($_GET['status'])){
									...
									"><a href="feedbacks.php">ALL FEEDBACKS</a>
                                </li>
								<?php
                                    ...
                                    echo '<li class='.(isset($_GET['status'])?($status == $_GET['status'] ? 'active' : ''): '').'><a href="feedbacks.php?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
      ...
      <section id="content">
        ...
        <div id="breadcrumbs-wrapper" style="background-image: url('images/chicken.jpg'); background-repeat: no-repeat; background-size: cover; width:80%">
          <div class="container">
            <div class="row">
        ...
        <div class="container">
          <p class="caption">Your feedbacks matters to us.Enjoy!!!</p>
          <div class="divider"></div>
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">YOUR FEEDBACKS</h4>
              </div>
<div>
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate" id="formValidate" method="post" action="routers/add-feedbacks.php" novalidate="novalidate" class="col s12">
                      <div class="row">
                        <div class="input-field col s12">
                          <input name="subject" id="subject" type="text" data-error=".errorTxt1">
                          <label for="subject" class="">FEEDBACKS</label>
                      ...
                      <div class="row">
                        ...
                        <input name="type" value="FEEDBACK" type="text" style= "display:none;">
                        </div>
                      </div>					  
                      <div class="row">
                        <div class="row">
        ...
        <div class="container" style="backdrop-filter: blur(10px);">
          ...
          <div class="divider"></div>
								...
								<?php
									...
									$sql = mysqli_query($con, "SELECT * FROM feedbacks WHERE poster_id = $user_id AND status LIKE '$status' AND not deleted;");
									while($row = mysqli_fetch_array($sql)){								                                
									echo'<a href="view-feedbacks.php?id='.$row['id'].'"class="collection-item">
                                        <div class="row">
                                            <div class="col s6">
...
<?php
	...
	else
	{
		...
		{
			header("location:all-feedbacks.php");		
		}
		else{
